...
console.log(color('\n🐶 YT CHANNEL: Ashen Rider','silver'))
console.log(color('🐶 WA NUMBER: +94784749430 ','silver'))
console.log(color('  🦄riderbot1🦄','mediumseagreen'))
    ...
    console.log(color('🐶', 'cyan'), color('https://wa.me/94784749430'))
    console.log(color('🐶', 'cyan'), color(' I am LIVING🌚💗', 'pink'))
    console.log(color('🐶', 'cyan'), color('Welcome Back Owner! Hope You Doing Well~', 'magenta'))
    console.log(color('🐶','red'), color('Thanks For Using  @𝖗𝖎𝖉𝖊𝖗𝖇𝖔𝖙1🤖', 'white'))
